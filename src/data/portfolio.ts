...
export const portfolioData: PortfolioData = {
    personal: {
        ...
        bio: 'Full-Stack Developer specializing in Next.js, React, and TypeScript. Currently building Servgo, a SaaS POS platform for cafés and restaurants. Background in data analytics with a passion for creating scalable web applications.',
